...
-- Started on 2021-10-29 14:12:06 CEST
...
CREATE TABLE public.mapea_control (
    ...
    need_config boolean DEFAULT false NOT NULL
);
...
CREATE TABLE public.mapea_plugin (
    ...
    javascript character varying(255) NOT NULL,
    styles character varying(255) NOT NULL,
    constructor character varying(255) NOT NULL,
    need_config boolean DEFAULT false NOT NULL
);
...
CREATE TABLE public."user" (
    ...
    name character varying(100) DEFAULT NULL::character varying NOT NULL,
    surname character varying(100) DEFAULT NULL::character varying NOT NULL
);
...
--
-- TOC entry 3104 (class 0 OID 299995)
-- Dependencies: 202
...
DoctrineMigrations\\Version20211029095316	2021-10-29 11:53:25	19
DoctrineMigrations\\Version20211029095623	2021-10-29 11:56:31	17
DoctrineMigrations\\Version20211029100542	2021-10-29 12:05:54	21
DoctrineMigrations\\Version20211029100829	2021-10-29 12:08:36	27
DoctrineMigrations\\Version20211029101110	2021-10-29 12:11:18	14
DoctrineMigrations\\Version20211029101456	2021-10-29 12:15:51	14
DoctrineMigrations\\Version20211029101657	2021-10-29 12:17:05	22
DoctrineMigrations\\Version20211029101836	2021-10-29 12:18:40	21
DoctrineMigrations\\Version20211029103852	2021-10-29 12:39:02	17
DoctrineMigrations\\Version20211029113523	2021-10-29 13:35:32	24
DoctrineMigrations\\Version20211029114723	2021-10-29 13:47:33	19
\.


--
-- TOC entry 3120 (class 0 OID 300104)
-- Dependencies: 218
...
--
-- TOC entry 3118 (class 0 OID 300094)
-- Dependencies: 216
...
--
-- TOC entry 3110 (class 0 OID 300031)
-- Dependencies: 208
-- Data for Name: mapea_control; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.mapea_control (id, name, constructor, need_config) FROM stdin;
1	Panzoombar	new M.control.Panzoombar()	f
2	LayerSwitcher	new M.control.LayerSwitcher()	f
3	OverviewMap	new M.control.OverviewMap()	f
4	Scale	new M.control.Scale()	f
5	ScaleLine	new M.control.ScaleLine()	f
7	Location	new M.control.Location()	f
9	rotate	new M.control.rotate()	f
6	Mouse	new M.control.Mouse()	t
8	GetFeatureInfo	new M.control.GetFeatureInfo()	t
\.


--
-- TOC entry 3112 (class 0 OID 300038)
-- Dependencies: 210
...
--
-- TOC entry 3105 (class 0 OID 299999)
-- Dependencies: 203
-- Data for Name: mapea_core; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.mapea_core (id, javascript, styles, configuration, name, description) FROM stdin;
1	https://mapea4-sigc.juntadeandalucia.es/js/mapea-6.0.0.ol.min.js	https://mapea4-sigc.juntadeandalucia.es/assets/css/mapea-6.0.0.ol.min.css	https://mapea4-sigc.juntadeandalucia.es/js/configuration-6.0.0.js	mapea_v6	Mapea v6 despliegue Sig-Corporativo
\.


--
-- TOC entry 3124 (class 0 OID 300134)
-- Dependencies: 222
...
--
-- TOC entry 3122 (class 0 OID 300115)
-- Dependencies: 220
...
--
-- TOC entry 3114 (class 0 OID 300051)
-- Dependencies: 212
-- Data for Name: mapea_plugin; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.mapea_plugin (id, name, javascript, styles, constructor, need_config) FROM stdin;
5	mapheader	https://emiliopardo.github.io/mapheader/mapheader.ol.min.js	https://emiliopardo.github.io/mapheader/mapheader.ol.min.css	M.plugin.Mapheader();	t
2	simplebaselayerselector	https://emiliopardo.github.io/simplebaselayerselector/simplebaselayerselector.ol.min.js	https://emiliopardo.github.io/simplebaselayerselector/simplebaselayerselector.ol.min.css	new M.plugin.Simplebaselayerselector();	t
1	InputSelectAddLayer	https://emiliopardo.github.io/inputselectaddlayer/inputselectaddlayer.ol.min.js	https://emiliopardo.github.io/inputselectaddlayer/inputselectaddlayer.ol.min.css	new M.plugin.Inputselectaddlayer();	f
3	simplelegend	https://emiliopardo.github.io/simplelegend/simplelegend.ol.min.js	https://emiliopardo.github.io/simplelegend/simplelegend.ol.min.css	new M.plugin.Simplelegend()	f
4	mapfooter	https://emiliopardo.github.io/mapfooter/mapfooter.ol.min.js	https://emiliopardo.github.io/mapfooter/mapfooter.ol.min.css	M.plugin.Mapfooter();	t
\.


--
-- TOC entry 3116 (class 0 OID 300077)
-- Dependencies: 214
...
--
-- TOC entry 3107 (class 0 OID 300007)
-- Dependencies: 205
-- Data for Name: user; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."user" (id, email, roles, password, username, name, surname) FROM stdin;
0	emilioj.pardo@juntadeandalucia.es	{"1":"ROLE_USER","2":"ROLE_SUPER_ADMIN"}	$2y$13$71tA0A2k6ZXDTITnWP0XPeVJ/O2BMIG9J7G1YyYBWzwaJdlRNDYkC	admin	admin	admin
14	test@test.com	["ROLE_USER","ROLE_EDITOR"]	$2y$13$LuiXxcnxAmpMLslTwjyiK.ttozjuwXVp7HpjOLCn7El2MmfVLN2Ti	test	test	test
16	e.pardo.perez@gmail.com	["ROLE_USER","ROLE_SUPER_ADMIN"]	$2y$13$ETydhDK6b5hFc5Yn4ehdsObZyZo0yw1lQbNv7iJodDh6LreOeE1iC	epardo	Emilio	Pardo
\.
...
--
-- TOC entry 2950 (class 2606 OID 300016)
...
--
-- TOC entry 2969 (class 2606 OID 300111)
...
--
-- TOC entry 2967 (class 2606 OID 300101)
...
--
-- TOC entry 2960 (class 2606 OID 300042)
...
--
-- TOC entry 2957 (class 2606 OID 300035)
...
--
-- TOC entry 2952 (class 2606 OID 300018)
...
--
-- TOC entry 2974 (class 2606 OID 300142)
...
--
-- TOC entry 2972 (class 2606 OID 300125)
...
--
-- TOC entry 2965 (class 2606 OID 300084)
...
--
-- TOC entry 2962 (class 2606 OID 300058)
...
--
-- TOC entry 2955 (class 2606 OID 300020)
...
--
-- TOC entry 2958 (class 1259 OID 300048)
...
--
-- TOC entry 2970 (class 1259 OID 300126)
...
--
-- TOC entry 2963 (class 1259 OID 300085)
...
--
-- TOC entry 2953 (class 1259 OID 300021)
...
--
-- TOC entry 2975 (class 2606 OID 300043)
...
--
-- TOC entry 2977 (class 2606 OID 300127)
...
--
-- TOC entry 2976 (class 2606 OID 300086)
...
-- Completed on 2021-10-29 14:12:06 CEST
